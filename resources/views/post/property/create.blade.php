                                ...
                                <div class="row">
									<div class="col-xl-6">
											<div class="form-group{{ $errors->has('budget') ? ' has-danger' : '' }}">
												...
												<input name="budget" type="number" id="input-budget" class="form-control form-control-alternative{{ $errors->has('budget') ? ' is-invalid' : '' }}" placeholder="{{ __('Budget') }}" value="{{ old('budget') }}" required>
